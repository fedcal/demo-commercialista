...
hero:
  name: "Demo Commercialista"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://commercialista.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-commercialista
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Commercialista.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Commercialista** in Italia.
...
Il mercato italiano delle PMI per **Commercialista** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:commercialista
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-commercialista)
