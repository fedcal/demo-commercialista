...
const SLUG = 'commercialista';
const TITLE = 'Demo Commercialista — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Commercialista.',
  base: `/demo-${SLUG}/`,
  cleanUrls: true,
