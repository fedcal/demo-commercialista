...
URL: `https://commercialista.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `commercialista.demo.federicocalo.dev`
...
- Output directory: `dist/commercialista/browser`
...
URL: `https://fedcal.github.io/federico-demo-commercialista/`
...
- `base: /federico-demo-commercialista/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `commercialista-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   commercialista-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `commercialista-docs.federicocalo.dev`
