...
import type { InfoAttivita, ServiziData, TeamData, FaqData, RisorseData } from './types';
...
export class MockDataService {
  ...
  readonly risorse$: Observable<RisorseData> = this.http
    .get<RisorseData>('/assets/mock/risorse.json')
    .pipe(shareReplay(1));
}
